...
class Program
{
    ...
    static void Main()
    {
        ...
        // debtors
        //    .FindAll(d => d.Email.EndsWith("rhyta.com") || d.Email.EndsWith("dayrep.com"))  
        ...
        // debtors
        //     .FindAll(d => DateTime.Now.Year- d.BirthDay.Year>=26
        //     && DateTime.Now.Year - d.BirthDay.Year < 36)
        //     .ForEach(d => Console.WriteLine(d));



        // Borcu 5000-den cox olmayan borclularic cixartmag
        // debtors.FindAll(d => d.Debt <= 5000).ForEach(d => Console.WriteLine(d));



        // Butov adi 18 simvoldan cox olan ve telefon nomresinde 2 ve ya 2-den cox 7 reqemi olan borclulari cixartmaq
        // debtors
        //     .FindAll(d => d.FullName.Length >= 18 && d.Phone.Count(c => c == '7')>=2) 
        //     .ForEach(d => Console.WriteLine(d));
        ...
        // debtors = debtors.FindAll(d=> d.Debt > debtors.Average(d=>d.Debt));
        // 
        // debtors.Sort((Debtor d1, Debtor d2) => d1.FullName.Split(' ')[2].CompareTo(d2.FullName.Split(' ')[2]));
        // 
        // debtors.ForEach(d => Console.WriteLine(d));
        // 
        // debtors.Sort((Debtor d1, Debtor d2) =>
        //  {
        //      if(d1.Debt > d2.Debt) return -1;
        //      if(d1.Debt < d2.Debt) return 1;
        //      return 0;
        //  });
        // debtors.ForEach(d => Console.WriteLine(d));
        ...
        //debtors = debtors.FindAll(d => d.Phone.Contains('8') == false);
        //debtors.Select(d => (d.FullName.Split(' ')[2], DateTime.Now.Year - d.BirthDay.Year, d.Debt)).Print();
        ...
        //         return false;
        //     });
        // temp.Sort((Debtor d1, Debtor d2) => d1.FullName.CompareTo(d2.FullName));
        // temp.ForEach(d => Console.WriteLine(d));
        ...
        // {
        //     tempYear = debtors[i].BirthDay.Year;
        //    Count = debtors.Count(d => d.BirthDay.Year == tempYear);
        ...
        // var temp = debtors.OrderByDescending(d => d.Debt).ToList();
        // 
        // for (int i = 0; i < 5; i++)
        // {
        ...
        // debtors.FindAll(d => d.BirthDay.Year >= 1941 && d.BirthDay.Year <= 1945).ForEach(d => Console.WriteLine(d));
        ...
        //     {
        //         d.Debt -= (12 - d.BirthDay.Month) * 500;
        //         return d.Debt <= 0;
        //     }
           
        //     else
        //     {
        //         for (int i = d.BirthDay.Month; i <= DateTime.Now.Month; i++)
        //             d.Debt -= 500;
        //         return d.Debt <= 0;
        //     }
        ...
        //        {
        //            if (d.FullName.ToLower().Contains(str[i]) == false)
        //                return false;
        //        }
        //        return true;
        //    }).Print();
